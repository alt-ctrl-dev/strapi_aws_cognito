...
module.exports = {
  ...
  async connect(ctx, next) {
    const grantConfig = await strapi
      ...
      .get();
      console.log("Auth connect grantConfig",grantConfig)
    ...
    const url_callback = _.get(ctx, 'query.callback') || grantConfig[provider].callback;
    console.log("Auth url_callback",url_callback)
    grantConfig[provider].callback = url_callback
    const url_connect = strapi.config.provider[provider].redirect_url || `${strapi.config.server.url}/connect/${provider}/callback`
    console.log("Auth url_connect",url_connect)
